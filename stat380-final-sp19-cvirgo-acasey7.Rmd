...
counts <- table(Heart$State)
barplot(counts, main = "state", xlab = "State", ylab = "# of people who use Tobacco")
...
ggplot(Heart, aes(x = Year)) +
  geom_histogram(stat = "count") +
  geom_bar(data = DeathData, aes(fill = `Cause of Death`))
```
