...
DeathData <-
  ...
  filter(State %in% c("Pennsylvania", "Texas", "Washington", "Maryland", "Nevada")) %>%
...
HeartData <-
  ...
  filter(State %in% c("Pennsylvania", "Texas", "Washington", "Maryland",)) %>%
  filter(Year %in% c(2005, 2006, 2007, 2008, 2009, 2010))
...
(B) .Rmd Line number(s) for visualization displaying many--3 or more--variables: 
