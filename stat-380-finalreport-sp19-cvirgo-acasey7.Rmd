...
(C)
```{r}
#Plot the count of current smokers by age group across all years and all states. 
...
(D)
```{r}
#Plot the count of heart disease deaths by age group across all years and all states. 
